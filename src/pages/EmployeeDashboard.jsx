                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
                    ...
                    {!completed && (
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '4px' }}>
                        <button className="btn" style={{ padding: '8px 16px', fontSize: '0.85rem', display: 'flex', alignItems: 'center', gap: '6px', backgroundColor: isImpersonating ? '#f59e0b' : 'var(--primary)', cursor: 'pointer' }} onClick={() => navigate(`/execucao/veiculo/${vehicle.id}`)}>
                          {isImpersonating ? '🧪 Testar Vistoria' : 'Iniciar Vistoria'} <ArrowRight size={14} />
                        </button>
                      </div>
                    )}
                  </div>
              ...
              {pendingShopping.map(list => (
                ...
                >
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                    <button className="btn" style={{ padding: '8px 16px', fontSize: '0.8rem', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '6px', backgroundColor: isImpersonating ? '#f59e0b' : '#0891b2', border: 'none', color: 'white', borderRadius: '20px', cursor: 'pointer' }}>
                      <Play size={12} fill="white" /> {isImpersonating ? 'Testar' : 'Preencher'}
                    </button>
                  </div>
                </div>
              ))}
          ...
          {pendingChecklists.length > 0 ? pendingChecklists.map(checklist => (
            <div 
              ...
              style={{ 
                padding: '16px 20px', 
                cursor: 'pointer', 
                borderLeft: isImpersonating ? '4px solid #f59e0b' : '4px solid #f97316', 
                backgroundColor: '#ffffff',
                borderRadius: '16px',
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minWidth: '60px', paddingRight: '12px', borderRight: '1px solid var(--border-color)' }}>
                <span style={{ fontSize: '1.1rem', fontWeight: 'bold', color: isImpersonating ? '#d97706' : '#0f172a' }}>HOJE</span>
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '6px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <div style={{ flex: 1, height: '6px', backgroundColor: '#e2e8f0', borderRadius: '3px', overflow: 'hidden' }}>
                    <div style={{ width: '0%', height: '100%', backgroundColor: isImpersonating ? '#f59e0b' : '#f97316' }}></div>
                  </div>
              ...
              {/* Right Action */}
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                <button className="btn" style={{ padding: '8px 16px', fontSize: '0.8rem', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '6px', backgroundColor: isImpersonating ? '#f59e0b' : '#0f172a', border: 'none', color: 'white', borderRadius: '20px', cursor: 'pointer' }}>
                  <Play size={12} fill="white" /> {isImpersonating ? 'Testar' : 'Iniciar'}
                </button>
              </div>
            </div>
          )) : (
